...
const VISION_COURT = "La Génération 7000 est une structure dont la mission est de vous inviter à redécouvrir l’Évangile de Christ et à comprendre son Royaume.Nous vous accompagnons pour bâtir une vie équilibrée qui nourrit votre éveil spirituel au quotidien.";
...
export default function Home() {
  ...
  <div className="absolute inset-0 bg-black/70" />
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          {/* Tag */}
          <p className="animate-fade-in font-body text-gray-500 text-white tracking-[0.5em] uppercase mb-8">
            1 Rois 19:18
          </p>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-30">
          <span className="text-white text-xs tracking-widest uppercase font-body">Défiler</span>
      ...
      <section className="py-28 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="font-body text-gray-400 text-xs tracking-[0.4em] uppercase mb-5">Notre ADN</p>
          <h2 className="font-display text-5xl md:text-6xl text-ink tracking-wider mb-8">LA VISION</h2>
          <div className="divider-ink" />
          <p className="font-body text-gray-600 text-lg leading-relaxed mb-10">{VISION_COURT}</p>
          <Link href="/apropos"
      ...
      <section className="py-28 px-6 bg-ash">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-14 gap-4">
            <div>
              <p className="font-body text-gray-400 text-xs tracking-[0.4em] uppercase mb-3">À venir</p>
              <h2 className="font-display text-5xl md:text-6xl text-ink tracking-wider">ÉVÉNEMENTS</h2>
            </div>
            <Link href="/evenements"
      ...
      <section className="py-28 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            {/* Texte */}
            <div>
              <p className="font-body text-gray-400 text-xs tracking-[0.4em] uppercase mb-3">Leadership</p>
              <h2 className="font-display text-4xl md:text-5xl text-ink tracking-wider mb-2">{leaderVedette.nom.toUpperCase()}</h2>
              <p className="font-accent italic text-gray-500 text-lg mb-6">{leaderVedette.role}</p>
              <div className="divider-left" />
              <p className="text-gray-600 leading-relaxed mb-8 max-w-lg">{leaderVedette.bio.slice(0, 160)}…</p>
