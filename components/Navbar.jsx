...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-ink border-b border-gray-800 h-16">
      <div className="max-w-6xl mx-auto px-6 h-full flex items-center justify-between">
        {/* Logo : conteneur avec hauteur fixe et centrage vertical */}
        <Link href="/" className="flex items-center h-full">
          <img
            src="/images/logo.png"
            alt="Logo"
            className="h-10 w-auto object-contain"
            // Ajustez h-12 (48px) selon vos goûts (h-10 = 40px, h-14 = 56px)
            // L'image s'adaptera sans dépasser ni modifier la hauteur du nav
          />
        </Link>
